      ...
      <React.Fragment>
        {this.state.editing ? (
          ...
          <IdeaEditPopup
            ...
            closePopupClick={this.closePopupClick}
        ...
        <div style={{ padding: "0 20px 0 20px" }}>
          ...
          >
            <div
              className={
                this.props.ideas[this.props.uuid]
                  ? this.props.ideas[this.props.uuid].mode
                  : null
              }
              style={{
                cursor: "pointer",
            ...
            >
              ...
              {this.state.level !== 0 && !this.props.shared ? (
                <Ionicon
                  style={{
                    position: "absolute",
                    right: 6,
            ...
            >
              {this.props.ideas[this.props.uuid]
                ? this.props.ideas[this.props.uuid].title
                : null}
            </div>
